...
public class Book implements Comparable<Book>, Serializable, Cloneable {
	...
	public int compareTo(Book book) {
		...
		if (this.author == null || this.title == null)
			throw new IllegalArgumentException("This object is not initialized yet");
		if (this.equals(book))
			return 0;
	...
	public Object clone() throws CloneNotSupportedException {
		...
		if (this.getKey() != null) book.setKey(this.getKey());
		if (this.getAuthor() != null) book.setAuthor(this.getAuthor());
		if (this.getTitle() != null) book.setTitle(this.getTitle());
		if (this.getDescription() != null) book.setDescription(this.getDescription());
		if (this.getAvailability() != null) book.setAvailability(this.getAvailability());
		if (this.getCount() != null) book.setCount(this.getCount());
		if (this.getWebsite() != null) book.setWebsite(this.getWebsite());
		if (this.getCoverPng() != null) book.setCoverPng(this.getCoverPng());
