...
public class BooksController {
	...
	public void incrementBook(ActionResponse response,
	...
	public void deleteBook(ActionResponse response,
			@RequestParam("book") Integer id) {
	...
	public void redirectToBookWebsite(ActionResponse response,
			@RequestParam("book") Integer id) throws IOException {
		Book book = bookService.getBook(id);
	...
	public void submitAddBookFormPage(ActionRequest request, ActionResponse response,
		...
		if (request.getParameter("_cancel") != null) {
			...
			switch (currentPage) {
				case 0: bookValidator.validateAuthor(book, result);	break;
				case 1: bookValidator.validateTitle(book, result); break;
				case 2: bookValidator.validateDescription(book, result); break;
				case 3: bookValidator.validateAvailability(book, result); break;
				case 4: bookValidator.validateCount(book, result); break;
				case 5: bookValidator.validateWebsite(book, result); break;
				case 6: bookValidator.validateCoverPng(book, result); break;
				default: ;
			}
